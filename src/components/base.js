  ...
  <main>
    ...
    <div className="sect__par">
      <div className="wrapper wrapper--narrow">
        ...
        <div className="headline headline__sect">
          <p>Email me at <a href="mailtio:taimoorsattar7@gmail.com">taimoorsattar7@gmail.com</a>. I would like to hear from you and will respond to your email in timely fashion.</p>
        </div>
